...
function v=passParams030614_mef(v)
         v.DIMERS = 9;
    ...
    function out=masterList2(SPECIES)
       ...
       for s=1:length(SPECIES)
        ...
        %v.pm(1,:) 	= [1.2e-6;   5.76e-08;   1.3e-8*10;   5e-7/20;   0;      6e-9]*t.*5;%/8 to make cRel lower; % const txn relb was 3e-8
        v.pm(1,:) 	= [0.6e-6;   5.76e-08;   1.3e-8*10;   5e-7/20;   0;      6e-9]*t.*5;%/8 to make cRel lower; % const txn relb was 3e-8
