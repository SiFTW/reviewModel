...
function v=passParams030614_dc(v)
         v.DIMERS = 9;
    ...
    function out=masterList2(SPECIES)
       ...
       for s=1:length(SPECIES)
        ...
        %v.pm(1,:) 	= [1.2e-6*0.17;   5.76e-08*1.04;   4.3900e-08*10;   1.5500e-06/20;   0;   6e-9*20].*5*t;
        v.pm(1,:) 	= [0.6e-6*0.34;   5.76e-08*1.04;   4.3900e-08*10;   1.5500e-06/20;   0;   6e-9*20].*5*t;
        ...
        v.ps(2) = (7.7e-4*t)./(4.61.*5); % NIK degradation (15 min half life)
